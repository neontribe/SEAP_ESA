module.exports = function(grunt){
    ...
    grunt.initConfig({
      ...
      concat: {
        js: {
          src: ['build/js/jquery.js', 'build/js/underscore.js', 'build/js/jquery.waypoints.js', 'build/js/storageapi.js', 'build/js/handlebars.js', 'build/js/scripts.js', 'build/js/seap-analytics.js', 'build/js/froogaloop.js'],
          dest: 'build/js/all-scripts.js'
        }
      },
      clean: {
        initial: ['build'],
        tidyup: ['build/js/jquery.js', 'build/js/scripts.js', 'build/js/jquery.waypoints.js', 'build/js/handlebars.js', 'build/js/html5.js', 'build/js/selectivizr-min.js', 'build/js/storageapi.js', 'build/js/underscore.js', 'build/js/seap-analytics.js', 'build/js/froogaloop.js', 'build/helpers', 'build/assessment-data.json', 'build/assessment.handlebars', 'build/stats-template.html', 'build/score-template.html', 'build/categories-template.html']
      },
      jshint: {
        options: {
          curly: true,
